...
/* package regex-ftc-0.1.0.0 */
#define VERSION_regex_ftc "0.1.0.0"
#define MIN_VERSION_regex_ftc(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "regex-ftc-0.1.0.0-4o6NQxocRYX9a1nXhmykiN"

#define CURRENT_PACKAGE_KEY "regex-ftc-0.1.0.0-4o6NQxocRYX9a1nXhmykiN"
